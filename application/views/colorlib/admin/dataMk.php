        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <br />
                        <?php $atrib = array('id' => 'demo-form2', 'class' => 'form-vertical form-label-left'); ?>
                        ...
                        <table class="table">
                            ...
                            <?php foreach ($rows->result() as $value): $no++?>
                                <tr>
                                    ...
                                    <td><?= $value->sks; ?></td>
                                    <td>
                                      <a href="<?= site_url('makul/select/'.$value->id_makul);?>">Edit </a> |
                                      <a href="<?= site_url('makul/delete/'.$value->id_makul);?>">Delete </a>
                                    </td>
                                </tr>
                            <?php endforeach ?>
                            </tbody>
